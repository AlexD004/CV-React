          ...
          <div className="bg-white p-3 mt-5 rounded">
            ...
            <main className='fluid d-flex justify-content-center row mb-5'>
              ...
              <section className="container col-sm-12 col-md-6">
                ...
                <p className='m-0'><FontAwesomeIcon icon={faLocationDot} size="sm"/> 40 Rue Laure Diebold, 69009 Lyon France</p>
                <p className='m-0'><FontAwesomeIcon icon={faMobileScreenButton} size="sm"/> <a href="tel:0620304050" className="text-dark">06 20 30 40 50</a></p>
